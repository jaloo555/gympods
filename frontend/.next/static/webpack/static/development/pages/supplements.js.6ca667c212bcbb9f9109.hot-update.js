...
function (_React$Component) {
  ...
  _createClass(Cart, [{
    key: "processFlavors",
    value: function processFlavors() {
      var str = "";
      this.state.flavors.forEach(function (el) {
        str = str + "|" + el;
      });
      return str;
    }
    ...
    value: function render() {
      var flavOptions = this.processFlavors.bind(this);
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        ...
        __self: this
      }, "ADD TO CART (", this.state.price, ") ", flavOptions);
    }
  }]);
...
//# sourceMappingURL=supplements.js.6ca667c212bcbb9f9109.hot-update.js.map