...
var Banner = function Banner(props) {
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("section", {
    id: "banner",
    className: "jsx-2584354580" + " " + "major-section",
    __source: {
    ...
    className: "jsx-2584354580" + " " + "inner",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 6
    },
    ...
    className: "jsx-2584354580" + " " + "major-header",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    },
    ...
    className: "jsx-2584354580" + " " + "content",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10
    },
    ...
    href: "/",
    className: "jsx-2584354580" + " " + "explore-button",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 12
    },
    ...
    className: "jsx-2584354580" + " " + "arrow bounce",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14
    },
    ...
    styleId: "2584354580",
    css: ".major-section.jsx-2584354580{background-image:url('static/gym-bg.png');height:100vh;background-position:center;background-repeat:no-repeat;background-size:cover;background-attachment:fixed;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;color:white;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;text-align:center;font-family:'Roboto',sans-serif;overflow:hidden;font-size:1.8vw;position:relative;margin:0;padding:0;}.major-header.jsx-2584354580>h1.jsx-2584354580{font-size:50px;margin:0 0 0.2em;font-weight:700;padding-bottom:20px;}.content.jsx-2584354580{text-transform:uppercase;}.content.jsx-2584354580>p.jsx-2584354580{margin:0 0 40px;font-size:30px;font-weight:300;}a.explore-button.jsx-2584354580{border:2px solid #FFFFFF;padding:0.5em 3em;box-sizing:border-box;-webkit-text-decoration:none;text-decoration:none;font-weight:400;font-size:20px;color:#FFFFFF;-webkit-transition:all 0.15s;transition:all 0.15s;border-color:tomato;}a.explore-button.jsx-2584354580:hover{color:#DDDDDD;background-color:tomato;-webkit-transition:all 0.3s ease-in-out 0s;-webkit-transition:all 0.3s ease-in-out 0s;transition:all 0.3s ease-in-out 0s;}a.explore-button.jsx-2584354580:active{color:#BBBBBB;border-color:#BBBBBB;}.arrow.jsx-2584354580{cursor:pointer;position:absolute;color:white;bottom:2rem;left:50%;font-size:35px;}.bounce.jsx-2584354580{-moz-animation:bounce 2s infinite;-webkit-animation:bounce 2s infinite;-webkit-animation:bounce-jsx-2584354580 2s infinite;animation:bounce-jsx-2584354580 2s infinite;}@-webkit-keyframes bounce-jsx-2584354580{0%,20%,50%,80%,100%{-webkit-transform:translateY(0);-ms-transform:translateY(0);transform:translateY(0);}40%{-webkit-transform:translateY(-30px);-ms-transform:translateY(-30px);transform:translateY(-30px);}60%{-webkit-transform:translateY(-15px);-ms-transform:translateY(-15px);transform:translateY(-15px);}}@keyframes bounce-jsx-2584354580{0%,20%,50%,80%,100%{-webkit-transform:translateY(0);-ms-transform:translateY(0);transform:translateY(0);}40%{-webkit-transform:translateY(-30px);-ms-transform:translateY(-30px);transform:translateY(-30px);}60%{-webkit-transform:translateY(-15px);-ms-transform:translateY(-15px);transform:translateY(-15px);}}@media all and (max-width:30em){a.explore-button.jsx-2584354580{margin:0.4em auto;}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */\n/*@ sourceURL=/Users/jason/Desktop/Code/JS/gympods/frontend/components/Index/Banner.js */",
    __self: this
  }));
};
...
var Section = function Section(props) {
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    className: "jsx-3126520633" + " " + "container",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 2
    },
    ...
    styleId: "3126520633",
    css: ".container.jsx-3126520633{background-color:gray;width:100vw;height:60vh;font-size:30px;text-align:center;}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */\n/*@ sourceURL=/Users/jason/Desktop/Code/JS/gympods/frontend/components/Index/Section.js */",
    __self: this
  }));
};
...
var Header = function Header(props) {
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("nav", {
    ...
    className: "jsx-4234533623" + " " + "leftList",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 7
    },
    ...
    className: "jsx-4234533623" + " " + "links one",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 8
    },
    ...
    className: "jsx-4234533623" + " " + "links two",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 9
    },
    ...
    className: "jsx-4234533623" + " " + "rightList",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 12
    },
    ...
    className: "jsx-4234533623" + " " + "links three",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13
    },
    ...
    className: "jsx-4234533623" + " " + "links cart",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14
    },
    ...
    styleId: "4234533623",
    css: "#header.jsx-4234533623{background-color:rgba(256,256,256,1.0);color:black;position:fixed;z-index:1;width:100vw;-webkit-transform:0.3s;-ms-transform:0.3s;transform:0.3s;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;}ul.jsx-4234533623{list-style:none;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;line-height:10px;padding:0;}.logo.jsx-4234533623{font-size:2.2em;justify-item:center;margin:0 auto;font-family:'Allerta Stencil',sans-serif;text-transform:uppercase;padding-top:5px;-webkit-text-decoration:none;text-decoration:none;}ul.jsx-4234533623>.links.jsx-4234533623{font-size:15px;padding-bottom:10px;padding-top:25px;text-transform:uppercase;font-weight:600;font-style:italic;}.leftList.jsx-4234533623>.links.jsx-4234533623{margin-left:20px;}.rightList.jsx-4234533623>.links.jsx-4234533623{margin-right:25px;}.links.jsx-4234533623>a.jsx-4234533623{position:relative;}.links.jsx-4234533623>a.jsx-4234533623:before{content:\"\";position:absolute;width:100%;height:2px;bottom:0;left:0;background-color:tomato;-webkit-transform:scaleX(0);-webkit-transform:scaleX(0);-ms-transform:scaleX(0);transform:scaleX(0);-webkit-transition:all 0.3s ease-in-out 0s;-webkit-transition:all 0.3s ease-in-out 0s;transition:all 0.3s ease-in-out 0s;visibility:hidden;}.cart.jsx-4234533623>a.jsx-4234533623:before{background-color:#fff3cd;}.links.jsx-4234533623>a.jsx-4234533623:hover.jsx-4234533623:before{visibility:visible;-webkit-transform:scaleX(1);-webkit-transform:scaleX(1);-ms-transform:scaleX(1);transform:scaleX(1);}a.jsx-4234533623{-webkit-text-decoration:none;text-decoration:none;color:inherit;}@media all and (max-width:900px){ul.jsx-4234533623{display:none;}.logo.jsx-4234533623{margin-left:auto;margin-right:auto;line-height:2.5em;}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */\n/*@ sourceURL=/Users/jason/Desktop/Code/JS/gympods/frontend/components/Layout/Header.js */",
    __self: this
  }));
};
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_lib_apollo__WEBPACK_IMPORTED_MODULE_6__["default"])(Index));
